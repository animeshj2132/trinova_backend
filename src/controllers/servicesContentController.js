...
export const getServicesContent = async (req, res, next) => {
  try {
...
// Get all services content for admin (including inactive)
export const getAllServicesContent = async (req, res, next) => {
  try {
    const { data: content, error } = await supabase
      .from('website_content')
      .select('*')
...
// Bulk update services content
export const bulkUpdateServicesContent = async (req, res, next) => {
  try {
